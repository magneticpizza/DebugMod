namespace DebugMod
{
    ...
    {
        [BindableMethod(name = "Give All", category = BindableCategory.Skills)]
        ...
        [BindableMethod(name = "Increment Dash", category = BindableCategory.Skills)]
        ...
        [BindableMethod(name = "Give Mantis Claw", category = BindableCategory.Skills)]
        ...
        [BindableMethod(name = "Give Monarch Wings", category = BindableCategory.Skills)]
        ...
        [BindableMethod(name = "Give Crystal Heart", category = BindableCategory.Skills)]
        ...
        [BindableMethod(name = "Give Isma's Tear", category = BindableCategory.Skills)]
        ...
        [BindableMethod(name = "Give Dream Nail", category = BindableCategory.Skills)]
        ...
        [BindableMethod(name = "Give Dream Gate", category = BindableCategory.Skills)]
        ...
        [BindableMethod(name = "Give Great Slash", category = BindableCategory.Skills)]
        ...
        [BindableMethod(name = "Give Dash Slash", category = BindableCategory.Skills)]
        ...
        [BindableMethod(name = "Give Cyclone Slash", category = BindableCategory.Skills)]
