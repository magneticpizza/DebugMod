...
1. Make sure you are in one of the rooms in RoomSpecifics.md
...
6. Change the value labeled useRoomSpecific to the value listed in RoomSpecifics.md to enable room specific savestates. (if you can't find it, search for 'useRoomSpecific' with Ctrl+f)
